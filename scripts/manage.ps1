# =========================================================
# NGA Mirror Station v4.0 - Management Script
# Usage:
...
Write-Host "  NGA Mirror Station v4.0 - Management Script" -ForegroundColor Cyan
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
# NGA Mirror Station v4.0 - Environment Variables
